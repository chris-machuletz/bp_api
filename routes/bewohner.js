...
router.post('/test', function(req, res) {
	...
	// }
	db.query(`INSERT INTO bewohner (nachname, vorname, zimmernummer, pflegegrad, geburtsdatum, geschlecht) VALUES ('test', 'test', 105, 1, STR_TO_DATE('2012-11-10', '%d-%m-%Y'), 'm')`, function (err, results) {
		if (err) {
			throw err
		} else {
